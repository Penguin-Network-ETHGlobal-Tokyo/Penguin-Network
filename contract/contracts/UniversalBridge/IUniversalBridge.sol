...
import "./bridges/PolygonBridgeUpward.sol";
import "./bridges/PolygonBridgeDownward.sol";
...
interface IUniversalBridge {
    ...
    function BRIDGE_POLYGON_UPWARD() external pure returns (PolygonBridgeUpward);
    // function BRIDGE_POLYGON_DOWNWARD() external pure returns (PolygonBridgeDownward);
